        ...
        init: function () {
            ...
            var displayConfirm = function() {
                $('.display-value', form).each(function(){
                    ...
                    } else if ($(this).attr("data-display") == 'applyid') {
                        var payment = [];
                        $('[name="applyid[]"]').each(function(){
							if($(this).attr("checked")=="checked")
							{
							   var applyid = $(this).val();
							   var year = $('[name="year['+applyid+']"] option:selected').text();
							   payment.push($(this).attr('data-title')+' <font style="color:red;font-size:8px;"> ['+year+']</font>');
							}							
                        });
