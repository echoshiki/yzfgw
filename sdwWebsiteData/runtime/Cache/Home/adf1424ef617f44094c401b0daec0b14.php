			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(MODULE_NAME == 'Member'): ?>active<?php endif; ?>">
					...
					<ul class="sub-menu">
						...
						<a href="<?php echo U('Member/create');?>">创建会员</a></li>
						<li <?php if(ACTION_NAME == 'List'): ?>class="active"<?php endif; ?> >
						<a href="<?php echo U('Member/List');?>">会员列表</a></li>
					</ul>
				</li>
				...
				<li class="<?php if(MODULE_NAME == 'Project'): ?>active<?php endif; ?>">
					...
					<ul class="sub-menu">
						<li <?php if(ACTION_NAME == 'create'): ?>class="active"<?php endif; ?> >
						<a href="<?php echo U('Project/create');?>">添加项目</a></li>
						<li <?php if(ACTION_NAME == 'List'): ?>class="active"<?php endif; ?> >
						<a href="<?php echo U('Project/List');?>">项目管理</a></li>
					</ul>
				</li>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<h3 class="page-title"> <?php echo session('agentname');?> <small>欢迎进入广陵区项目管理系统</small></h3>
			</div>
		</div>
		<!-- END PAGE HEADER-->
		<div id="dashboard">
