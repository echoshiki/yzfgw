	...
	<div class="container-fluid">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>用户详情</div>
				<div class="tools"></div>
			</div>
...
<!-- 				<div class="clearfix">
				...
				<table class="table table-striped table-hover table-bordered dataTable">
					<tbody>
						...
						<tr>
							<td><span class="font-title">归属<span></td>
							<td><?php echo ($view["groupname"]); ?></td>
						</tr>
						<tr>
							<td><span class="font-title">注册日期<span></td>
							<td><?php echo ($view["registered"]); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo ($view["qq"]); ?></td>
						</tr>
						<tr>
							<td colspan="2"><a class="btn blue" href="javascript:history.go(-1)">返回</a></td>
						</tr>
					</tbody>
				</table>

				<div class="row-fluid">
					<div class="span6"><div class="dataTables_info" id="sample_editable_1_info"></div></div>
					<div class="span6" style="float:right; width:260px">
						<?php echo ($page); ?>
					</div></div>
				</div>
			</div>
