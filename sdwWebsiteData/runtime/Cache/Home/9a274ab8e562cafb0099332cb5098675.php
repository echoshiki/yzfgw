	...
	<div class="container-fluid">
		...
		<!-- END PAGE HEADER-->
				<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Member/member_group_list');?>">用户组管理</a>
								<span class="icon-angle-right"></span>
							</li>
							<li>
								<span>用户组编辑</span>
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>用户组编辑</div>
				<div class="tools"></div>
			</div>
...
<!-- 				<div class="clearfix">
				...
				<form action="" method="POST" name="member_group_edit" id="member_group_edit">
					<table class="table table-striped table-hover table-bordered dataTable">
						<tbody>
							<tr class="odd">
								<td style="width:200px;"><span class="font-title">用户id<span></td>
								<td><?php echo ($view["groupid"]); ?></td>
							</tr>
							<tr class="odd">
								<td><span class="font-title">用户组名<span></td>
								<td><input type="text" value="<?php echo ($view["groupname"]); ?>" name="groupname"></td>
							</tr>
							<tr class="odd">
								<td><span class="font-title">备注<span></td>
								<td><input type="text" value="<?php echo ($view["note"]); ?>" name="note"></td>
							</tr>
							<tr>
								<td colspan="2"><button class="btn green" name="submit" value="1">编辑</button>&nbsp;<a class="btn blue" href="javascript:history.go(-1)">返回</a></td>
							</tr>
...
$("#member_group_edit").validate({
				...
				messages: {
				   groupname: {
				    required: "请输入用户名",
				    minlength: "用户组名长度为2-10之间",
				    maxlength: "用户组名长度为2-10之间"
				   },
		        }
		});
