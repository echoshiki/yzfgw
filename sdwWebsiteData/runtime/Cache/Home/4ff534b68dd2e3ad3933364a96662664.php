			...
			<ul class="page-sidebar-menu">
              ...
              <?php if(($_SESSION['usertype'] == 1) or ($_SESSION['usertype'] == 2)): ?><li class="<?php if(MODULE_NAME == 'Member'): ?>active<?php endif; ?>">
					...
					<ul class="sub-menu">
						...
						<a href="<?php echo U('Member/MemberCreate');?>">创建用户</a></li>
						<li <?php if(ACTION_NAME == 'List'): ?>class="active"<?php endif; ?> >
						<a href="<?php echo U('Member/MemberList');?>">用户管理</a></li>
					</ul>
				</li><?php endif; ?>
...
<form action="__APP__/Project/editemonthpreport" method="post" accept-charset="utf-8">
        ...
        <div>
            <table id="addNode" class="s-table" width="100%" border="1" cellspacing="1" bordercolor="#CCCCCC" cellpadding="0">
                ...
                <tr>
                    <td>计划</td>
                    <td><?php echo ($projecteditemr["build_plan_demolition"]); ?><input name="build_plan_demolition" type="hidden" value="<?php echo ($projecteditemr["build_plan_demolition"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_piling"]); ?><input name="build_plan_piling" type="hidden" value="<?php echo ($projecteditemr["build_plan_piling"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_excavate"]); ?><input name="build_plan_excavate" type="hidden" value="<?php echo ($projecteditemr["build_plan_excavate"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_pmz"]); ?><input name="build_plan_pmz" type="hidden" value="<?php echo ($projecteditemr["build_plan_pmz"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_cap"]); ?><input name="build_plan_cap" type="hidden" value="<?php echo ($projecteditemr["build_plan_cap"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_completion"]); ?><input name="build_plan_completion" type="hidden" value="<?php echo ($projecteditemr["build_plan_completion"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_device"]); ?><input name="build_plan_device" type="hidden" value="<?php echo ($projecteditemr["build_plan_device"]); ?>" /></td>
                    <td><?php echo ($projecteditemr["build_plan_partproduction"]); ?><input name="build_plan_partproduction" type="hidden" value="<?php echo ($projecteditemr["build_plan_partproduction"]); ?>" /></td>
                    <td colspan="2"><?php echo ($projecteditemr["build_plan_allproduction"]); ?><input name="build_plan_allproduction" type="hidden" value="<?php echo ($projecteditemr["build_plan_allproduction"]); ?>" /></td>
                </tr>
                <tr>
                		<td>实际</td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_demolition"]); ?>" name="build_actual_demolition"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_piling"]); ?>" name="build_actual_piling"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_excavate"]); ?>" name="build_actual_excavate"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_pmz"]); ?>" name="build_actual_pmz"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_cap"]); ?>" name="build_actual_cap"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_completion"]); ?>" name="build_actual_completion"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_device"]); ?>" name="build_actual_device"></td>
                		<td><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_partproduction"]); ?>" name="build_actual_partproduction"></td>
                		<td colspan="2"><input type="text" style="width:87%" class="normal datepicker"  value="<?php echo ($projecteditemr["build_actual_allproduction"]); ?>" name="build_actual_allproduction"></td>
                </tr>
            </table>
		...
		<table class="s-table" border="1" cellspacing="1" bordercolor="#CCCCCC" cellpadding="0" width="100%">
                ...
                <tr>
                    <td height="59" colspan="6" align="center"><label>
                    		<textarea name="content_jinzhan" id="content_jinzhan" cols="45" rows="5" style="width:96%"><?php echo ($projecteditemr["content_jinzhan"]); ?></textarea>
                    </label></td>
                    </tr>
            </table>
			</div>
 <div>
            <table class="s-table" border="1" cellspacing="1" bordercolor="#CCCCCC" cellpadding="0" width="100%">
                ...
                <tr>
                    <td height="59" colspan="6" align="center"><label>
                    		<textarea name="content_problem" id="content_problem" cols="45" rows="5" style="width:96%"><?php echo ($projecteditemr["content_problem"]); ?></textarea>
                    </label></td>
                    </tr>
            </table>
        </div>
		<div>
            <table class="s-table" border="1" cellspacing="1" bordercolor="#CCCCCC" cellpadding="0" width="100%">
                ...
                <tr>
                    <td height="59" colspan="6" align="center"><label>
                    		<textarea name="content_leader" id="content_leader" cols="45" rows="5" style="width:96%"><?php echo ($projecteditemr["content_leader"]); ?></textarea>
                    </label></td>
                    </tr>
            </table>
        </div>
...
<input name="id" type="hidden" value="<?php echo ($projecteditemr["id"]); ?>" />
