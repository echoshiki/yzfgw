	...
	<div class="container-fluid">
		...
		<!-- END PAGE HEADER-->
				<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo U('Project/List');?>">用户管理</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="<?php echo U('Project/create');?>">创建用户</a></li>
		...
		<form action="" method="post">
				<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#CCCCCC" class="s-table">
						...
						<tr >
								<td width="11%">用户名<span class="required">*</span></td>
								<td width="89%"><input type="text" class="normal" name="base[projectcoding]" /></td>
						</tr>
						<tr class="even">
								<td>密　码<span class="required">*</span></td>
								<td><input type="password" class="normal" name="base[name]" /></td>
								</tr>
						<tr>
								<td>所属类别</td>
								<td style="width: 8%"><select name="base[citytype]" id="base[citytype]">
						...
						<tr  class="even">
								<td>手机号码</td>
								<td><input type="text" class="normal" name="base[partner]" /></td>
						</tr>
						<tr>
								<td>职　　位</td>
								<td><input type="text" class="normal" name="base[cooperation]" /></td>
						</tr>
		<td>电子邮件<span class="required">*</span></td>
						<td><input type="text" class="normal" name="base[type]" />						</td>
				</table>
